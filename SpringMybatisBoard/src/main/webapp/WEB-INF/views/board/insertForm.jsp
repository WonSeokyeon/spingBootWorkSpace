	...
	<div class="notion-container">
		...
		<form:form modelAttribute="boardDTO" action="insert">
			...
			<div class="notion-form-group">
				...
				<form:input path="title" class="notion-input"
			...
			<div class="notion-form-group">
				...
				<form:input path="writer" class="notion-input"
			...
			<div class="notion-form-group">
				...
				<form:textarea path="content" class="notion-input notion-textarea"
					placeholder="여기에 내용을 자유롭게 끄적여보세요..." />
		...
		<div class="notion-btn-group">
			<button type="button" id="btnList" class="notion-btn">📁
				List</button>
			<button type="button" id="btnInsert"
				class="notion-btn notion-btn-primary">✨ Insert</button>
		</div>
	</div>
</body>
</html>