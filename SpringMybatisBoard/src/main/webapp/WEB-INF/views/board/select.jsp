...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/selectForm.css">
...
<body>
	<div class="notion-detail-wrapper">
		...
		<div class="notion-content-area">${boardDTO.content}</div>
		...
		<div class="notion-action-group">
			...
			<div class="right-actions">
				<a href="/board/updateForm?boardNo=${boardDTO.boardNo}"
					class="notion-btn edit-btn">✍️ 수정</a> <a
					href="/board/delete?boardNo=${boardDTO.boardNo}"
					class="notion-btn delete-btn"
