	...
	<div class="notion-update-wrapper">
		<form action="/board/update" method="post">
			...
			<div class="notion-page-header">
				<span class="notion-page-icon">📝</span> <input type="text"
					name="title" class="notion-title-input" value="${boardDTO.title}"
					placeholder="제목 없음" required autocomplete="off">
			</div>
			...
			<div class="notion-properties">
				...
				<div class="notion-property-row">
					...
					<div class="property-value">
						<input type="text" name="writer" class="notion-writer-input"
							value="${boardDTO.writer}" required autocomplete="off"
							placeholder="작성자 이름">
					</div>
				</div>
				...
				<div class="notion-property-row">
					...
					<div class="property-value">
						<span class="date-text"> <fmt:formatDate
								value="${boardDTO.regDate}" pattern="yyyy-MM-dd HH:mm" />
						</span>
					</div>
				</div>
			...
			<div class="notion-action-group">
				<div class="left-actions">
					<a href="/board/select?boardNo=${boardDTO.boardNo}"
						class="notion-btn cancel-btn">취소</a>
				</div>
				<div class="right-actions">
					<button type="submit" class="notion-btn submit-btn">💾
						저장하기</button>
				</div>
			</div>
		</form>
